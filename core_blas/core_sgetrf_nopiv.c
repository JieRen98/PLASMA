 ...
 * @ingroup CORE_float
 *
 *  CORE_sgetrf_nopiv computes an LU factorization of a general diagonal
...
#pragma weak CORE_sgetrf_nopiv = PCORE_sgetrf_nopiv
#define CORE_sgetrf_nopiv PCORE_sgetrf_nopiv
#endif
                      ...
                      float *A, int LDA)
{
    ...
    for(i =0 ; i < k; i += IB) {
         ...
         */
        iinfo = CORE_sgetf2_nopiv( M-i, sb, &A[LDA*i+i], LDA );
