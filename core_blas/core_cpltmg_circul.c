 ...
 *
 *  CORE_cpltmg_circul is a kernel used in circulant matrix generation
 *
...
#pragma weak CORE_cpltmg_circul = PCORE_cpltmg_circul
#define CORE_cpltmg_circul PCORE_cpltmg_circul
#endif
