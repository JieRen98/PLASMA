 ...
 *
 *  CORE_cgblrx is a kernel that will operate on a region (triangle) of data
 ...
 *  and update V and TAU, then it continue until finishing the the whole
 *  column. When this is done, it take advantage that data are on cache and will
 *  apply the right on the remaining part of this region that has not been
 *  updated by the right yet.
 *
 *******************************************************************************
 *
 * @param[in] uplo
 ...
 ******************************************************************************/
int
CORE_cgblrx(PLASMA_enum uplo, int N,
            PLASMA_desc *A,
