 ...
 *
 *  CORE_cpltmg_hankel is a kernel used in Hankel matrix generation
 *
...
#pragma weak CORE_cpltmg_hankel = PCORE_cpltmg_hankel
#define CORE_cpltmg_hankel PCORE_cpltmg_hankel
#endif
