 ...
 * @ingroup CORE_float
 *
 *  CORE_ssbtype3cb is a kernel that will operate on a region (triangle) of data
...
#pragma weak CORE_ssbtype3cb = PCORE_ssbtype3cb
#define CORE_ssbtype3cb PCORE_ssbtype3cb
#endif
