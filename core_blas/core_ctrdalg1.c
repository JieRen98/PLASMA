 ...
 *
 *  CORE_ctrdalg1 is a part of the tridiagonal reduction algorithm (bulgechasing)
 ...
 *
 * @param[in] work
 *          Workspace of size nb. Used by the core_chbtype[123]cb.
 *
 ******************************************************************************/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_ctrdalg1 = PCORE_ctrdalg1
#define CORE_ctrdalg1 PCORE_ctrdalg1
#endif
void CORE_ctrdalg1( int n, int nb,
