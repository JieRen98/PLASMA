...
static inline int CORE_cpamm_a2(PLASMA_enum side, PLASMA_enum trans, PLASMA_enum uplo,
...
static inline int CORE_cpamm_w(PLASMA_enum side, PLASMA_enum trans, PLASMA_enum uplo,
                               int M, int N, int K, int L,
                               int vi2, int vi3,
 ...
 ******************************************************************************/
int
CORE_cpamm(int op, PLASMA_enum side, PLASMA_enum storev,
           int M, int N, int K, int L,
           const PLASMA_Complex32_t *A1, int LDA1,
                 PLASMA_Complex32_t *A2, int LDA2,
           const PLASMA_Complex32_t *V, int LDV,
...
/***************************************************************************/
static inline int
CORE_cpamm_w(PLASMA_enum side, PLASMA_enum trans, PLASMA_enum uplo,
             int M, int N, int K, int L,
             int vi2, int vi3,
             const PLASMA_Complex32_t *A1, int LDA1,
                   PLASMA_Complex32_t *A2, int LDA2,
...
/***************************************************************************/
static inline int
CORE_cpamm_a2(PLASMA_enum side, PLASMA_enum trans, PLASMA_enum uplo,
              int M, int N, int K, int L,
              int vi2, int vi3,
                    PLASMA_Complex32_t *A2, int LDA2,
              const PLASMA_Complex32_t *V, int LDV,
