 ...
 * @ingroup CORE_float
 *
 *  CORE_spltmg_hankel is a kernel used in Hankel matrix generation
 *
...
#pragma weak CORE_spltmg_hankel = PCORE_spltmg_hankel
#define CORE_spltmg_hankel PCORE_spltmg_hankel
#endif
