 ...
 * @ingroup CORE_double
 *
 *  CORE_dgetrf_nopiv computes an LU factorization of a general diagonal
...
#pragma weak CORE_dgetrf_nopiv = PCORE_dgetrf_nopiv
#define CORE_dgetrf_nopiv PCORE_dgetrf_nopiv
#endif
                      ...
                      double *A, int LDA)
{
    ...
    for(i =0 ; i < k; i += IB) {
         ...
         */
        iinfo = CORE_dgetf2_nopiv( M-i, sb, &A[LDA*i+i], LDA );
