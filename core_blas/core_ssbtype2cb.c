 ...
 * @ingroup CORE_float
 *
 *  CORE_ssbtype2cb is a kernel that will operate on a region (triangle) of data
...
#pragma weak CORE_ssbtype2cb = PCORE_ssbtype2cb
#define CORE_ssbtype2cb PCORE_ssbtype2cb
#endif
                     ...
                     float *WORK)
{
    ...
    if( lem > 1 ) {
        ...
        *V(vpos) = 1.;
        ...
        LAPACKE_slarfg_work( lem, A(J1, st), V(vpos+1), 1, TAU(taupos) );
