 ...
 * @ingroup CORE_double
 *
 *  CORE_dgbtype3cb is a kernel that will operate on a region (triangle) of data
...
#pragma weak CORE_dgbtype3cb = PCORE_dgbtype3cb
#define CORE_dgbtype3cb PCORE_dgbtype3cb
#endif
