 ...
 *
 *  CORE_zhbtype1cb is a kernel that will operate on a region (triangle) of data
...
#pragma weak CORE_zhbtype1cb = PCORE_zhbtype1cb
#define CORE_zhbtype1cb PCORE_zhbtype1cb
#endif
