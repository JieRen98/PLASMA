 ...
 *
 *  CORE_ztrdalg1 is a part of the tridiagonal reduction algorithm (bulgechasing)
...
#pragma weak CORE_ztrdalg1 = PCORE_ztrdalg1
#define CORE_ztrdalg1 PCORE_ztrdalg1
#endif
void CORE_ztrdalg1( int n, int nb,
