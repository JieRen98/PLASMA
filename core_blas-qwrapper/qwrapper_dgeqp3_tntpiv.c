                              ...
                              PLASMA_bool check_info, int iinfo)
{
    ...
    QUARK_Insert_Task(quark, CORE_dgeqp3_tntpiv_quark, task_flags,
        sizeof(int),                        &m,             VALUE,
        sizeof(int),                        &n,             VALUE,
        sizeof(double)*nb*nb,    A,                     INOUT | LOCALITY,
        sizeof(int),                        &lda,           VALUE,
        sizeof(int)*nb,                      IPIV,                  OUTPUT,
        sizeof(double)*min(m,n),    NULL,               SCRATCH,
...
#pragma weak CORE_dgeqp3_tntpiv_quark = PCORE_dgeqp3_tntpiv_quark
#define CORE_dgeqp3_tntpiv_quark PCORE_dgeqp3_tntpiv_quark
#endif
void CORE_dgeqp3_tntpiv_quark(Quark *quark)
{
    ...
    info = CORE_dgeqp3_tntpiv(m, n, A, lda, IPIV, tau, iwork );
