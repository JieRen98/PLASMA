 ...
 *
 *  PLASMA_zungqr - Generates an M-by-N matrix Q with orthonormal columns, which
 ...
 *
 *  PLASMA_zungqr_Tile - Generates an M-by-N matrix Q with orthonormal columns,
 *  which is defined as the first N columns of a product of the elementary
 *  reflectors returned by PLASMA_zgeqrf.
