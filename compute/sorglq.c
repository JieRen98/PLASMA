 ...
 * @ingroup float
 *
 *  PLASMA_sorglq - Generates an M-by-N matrix Q with orthonormal rows, which is
 ...
 * @ingroup float_Tile
 *
 * PLASMA_sorglq_Tile - Generates an M-by-N matrix Q with orthonormal rows,
 * which is defined as the first M rows of a product of the elementary
 * reflectors returned by PLASMA_sgelqf.
