 ...
 * @ingroup float
 *
 *  PLASMA_sorgqr - Generates an M-by-N matrix Q with orthonormal columns, which
 ...
 * @ingroup float_Tile
 *
 *  PLASMA_sorgqr_Tile - Generates an M-by-N matrix Q with orthonormal columns,
 *  which is defined as the first N columns of a product of the elementary
 *  reflectors returned by PLASMA_sgeqrf.
