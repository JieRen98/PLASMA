                  ...
                  double beta,  PLASMA_Complex64_t *C, int LDC)
{
    ...
    if ( PLASMA_TRANSLATION == PLASMA_OUTOFPLACE ) {
        ...
        plasma_zooplap2tile( descB, B, NB, NB, LDB, An, 0, 0, Am, An, sequence, &request,
                             plasma_desc_mat_free(&(descA)); plasma_desc_mat_free(&(descB)));
        plasma_zooplap2tile( descC, C, NB, NB, LDC, N,  0, 0, N,  N,   sequence, &request,
    ...
    if ( PLASMA_TRANSLATION == PLASMA_OUTOFPLACE ) {
        ...
        plasma_ziptile2lap( descB, B, NB, NB, LDB, An,  sequence, &request);
 ...
 * @sa PLASMA_dher2k_Tile
 * @sa PLASMA_sher2k_Tile
 *
 ******************************************************************************/
