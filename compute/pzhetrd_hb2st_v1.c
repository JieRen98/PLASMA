        ...
        if( my_core_id == 0 ) {
            ...
            if( standalonework != 0 ) {
                 ...
                 */
                    ...
                    plasma_error("pzhetrd_hb2st_v1", "PlasmaUpper is not supported\n");
                    plasma_request_fail(sequence, request, PLASMA_ERR_NOT_SUPPORTED);
                    return;
                }
            }
 ...
 **/
/***************************************************************************/
void plasma_pzhetrd_hb2st_v1_quark(PLASMA_enum uplo, int N, int NB, int Vblksiz,
