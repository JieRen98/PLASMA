 ...
 * @date 2010-11-15
 * @generated d Fri Apr  1 11:02:53 2016
 *
 **/
#include "common.h"
 ...
 * @ingroup double
 *
 *  PLASMA_dlaswpc - performs a series of row interchanges on the matrix A.
 ...
 *
 ******************************************************************************/
int PLASMA_dlaswpc(int N, double *A, int LDA,
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dlaswpc_Tile - performs a series of row interchanges on the matrix A.
 *  One row interchange is initiated for each of rows K1 through K2 of A.
 *  Tile equivalent of PLASMA_dlaswpc().
 ...
 *
 *  PLASMA_dlaswpc_Tile_Async - performs a series of row interchanges
 *  on the matrix A.  One row interchange is initiated for each of
 *  rows K1 through K2 of A.
 *  Non-blocking equivalent of PLASMA_dlaswpc_Tile().
                             ...
                             PLASMA_sequence *sequence, PLASMA_request *request)
{
    ...
    if ( (K1 != 1) || (K2 != descA.n) ) {
        plasma_error("PLASMA_dlaswpc_Tile", "invalid K1 or K2 (1..N is the only interval supported right now)");
        return plasma_request_fail(sequence, request, PLASMA_ERR_ILLEGAL_VALUE);
    }
