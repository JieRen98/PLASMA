        ...
        *sumsq = 1.;
        ...
        while (n < A.nt) {
            ...
            if (m == n) {
                ...
                ldam = BLKLDD(A, m);
                CORE_zsyssq( uplo, X, A(m, n, X1, X1, ldam), ldam, scale, sumsq );
            }
            else {
                scale2 = 0.;
                sumsq2 = 1.;
                ...
                if (uplo == PlasmaLower) {
                    ...
                    ldam = BLKLDD(A, m);
                    CORE_zgessq( X, Y, A(m, n, X1, Y1, ldam), ldam, &scale2, &sumsq2 );
                }
                /*
                 *  PlasmaUpper
                 */
                    ...
                    ldan = BLKLDD(A, n);
                    CORE_zgessq( X, Y, A(n, m, X1, Y1, ldan), ldan, &scale2, &sumsq2 );
                }
                sumsq2 *= 2.;
