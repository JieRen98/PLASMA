                                  ...
                                  PLASMA_sequence *sequence, PLASMA_request *request )
{
    ...
    work = (double**) malloc ( A.mt * sizeof( double* ) );
    ...
    for (k = 0; k < A.mt; k++) {
        ...
        work[k] = (double*)plasma_shared_alloc(plasma, 2*tempkm, PlasmaRealDouble);

        QUARK_CORE_dpltmg_toeppd1(
