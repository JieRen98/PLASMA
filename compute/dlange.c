                     ...
                     double *A, int LDA)
{
    ...
    PLASMA_dlange_Tile_Async(norm, &descA, &value, sequence, &request);
...
double PLASMA_dlange_Tile(PLASMA_enum norm, PLASMA_desc *A)
{
    ...
    plasma_sequence_create(plasma, &sequence);
    PLASMA_dlange_Tile_Async(norm, A, &value, sequence, &request);
    plasma_dynamic_sync();
    plasma_sequence_destroy(plasma, sequence);
    return value;
}
 ...
 *
 ******************************************************************************/
int PLASMA_dlange_Tile_Async(PLASMA_enum norm, PLASMA_desc *A, double *value,
