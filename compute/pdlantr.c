 ...
 *
 **/
void plasma_pdlantr_quark(PLASMA_enum norm, PLASMA_enum uplo, PLASMA_enum diag,
                          PLASMA_desc A, double *work, double *result,
