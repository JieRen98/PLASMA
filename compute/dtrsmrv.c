 ...
 *
 ******************************************************************************/
int PLASMA_dtrsmrv(PLASMA_enum side, PLASMA_enum uplo,
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dtrsmrv_Tile - Computes triangular solve.
 *  Tile equivalent of PLASMA_dtrsmrv().
 ...
 *
 ******************************************************************************/
int PLASMA_dtrsmrv_Tile(PLASMA_enum side, PLASMA_enum uplo,
                      PLASMA_enum transA, PLASMA_enum diag,
 ...
 *
 *  PLASMA_dtrsmrv_Tile_Async - Computes triangular solve.
 *  Non-blocking equivalent of PLASMA_dtrsmrv_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_dtrsmrv_Tile_Async(PLASMA_enum side, PLASMA_enum uplo,
                            PLASMA_enum transA, PLASMA_enum diag,
                            double alpha, PLASMA_desc *A, PLASMA_desc *B,
