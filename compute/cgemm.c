                 ...
                 PLASMA_Complex32_t beta,  PLASMA_Complex32_t *C, int LDC)
{
    ...
    if ( PLASMA_TRANSLATION == PLASMA_OUTOFPLACE ) {
        ...
        plasma_cooplap2tile( descB, B, NB, NB, LDB, Bn, 0, 0, Bm, Bn, sequence, &request,
    ...
    if ( PLASMA_TRANSLATION == PLASMA_OUTOFPLACE ) {
        ...
        plasma_ciptile2lap( descB, B, NB, NB, LDB, Bn,  sequence, &request);
                            ...
                            PLASMA_sequence *sequence, PLASMA_request *request)
{
    ...
    if ( (Ai%Amb != descC.i%descC.mb) || (Aj%Anb != Bi%Bmb) || (Bj%Bnb != descC.j%descC.nb) ) {
