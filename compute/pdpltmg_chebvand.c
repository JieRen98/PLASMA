                                   ...
                                   PLASMA_sequence *sequence, PLASMA_request *request )
{
    ...
    W = (double**) malloc ( A.nt * sizeof( double* ) );
    ...
    for (n = 0; n < A.nt; n++) {
        ...
        W[n] = (double*)plasma_shared_alloc(plasma, 2*tempnn, PlasmaRealDouble);
