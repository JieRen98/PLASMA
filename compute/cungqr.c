 ...
 *
 *  PLASMA_cungqr - Generates an M-by-N matrix Q with orthonormal columns, which
                  ...
                  PLASMA_Complex32_t *Q, int LDQ)
{
    ...
    if ( PLASMA_TRANSLATION == PLASMA_OUTOFPLACE ) {
        plasma_cooplap2tile( descA, A, NB, NB, LDA, N, 0, 0, M, K, sequence, &request,
 ...
 *
 *  PLASMA_cungqr_Tile - Generates an M-by-N matrix Q with orthonormal columns,
 *  which is defined as the first N columns of a product of the elementary
 *  reflectors returned by PLASMA_cgeqrf.
