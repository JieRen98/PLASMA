                     ...
                     PLASMA_Complex32_t *A, int LDA)
{
    ...
    PLASMA_clange_Tile_Async(norm, &descA, &value, sequence, &request);
...
float PLASMA_clange_Tile(PLASMA_enum norm, PLASMA_desc *A)
{
    ...
    plasma_sequence_create(plasma, &sequence);
    PLASMA_clange_Tile_Async(norm, A, &value, sequence, &request);
    plasma_dynamic_sync();
    plasma_sequence_destroy(plasma, sequence);
    return value;
}
 ...
 *
 ******************************************************************************/
int PLASMA_clange_Tile_Async(PLASMA_enum norm, PLASMA_desc *A, float *value,
