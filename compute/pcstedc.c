 ...
 *
 *  plasma_pcstedc - solves the symmetric tridiagonal eigensystem using LAPACK's
 *  divide and conquer
 *
 *******************************************************************************
 *
...
void plasma_pcstedc_quark(PLASMA_enum compz, int n, float *D, float *E,
                          ...
                          PLASMA_sequence *sequence, PLASMA_request *request)
{
    ...
    QUARK_CORE_cstedc(plasma->quark, &task_flags,
                      compz, n, D, E, Z, LDZ);
}
