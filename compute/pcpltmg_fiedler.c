 ...
 **/
void plasma_pcpltmg_fiedler_quark( PLASMA_desc A, unsigned long long int seed,
                                   PLASMA_sequence *sequence, PLASMA_request *request )
{
    ...
    for (m = 0; m < A.mt; m++) {
        ...
        work[m] = (PLASMA_Complex32_t*)plasma_shared_alloc(plasma, tempmm, PlasmaComplexFloat);
    ...
    for (m = 0; m < A.mt; m++) {
        ...
        QUARK_CORE_free(plasma->quark, &task_flags,
                        work[m], (tempmm)*sizeof(PLASMA_Complex32_t));
    }
