                                 ...
                                 PLASMA_sequence *sequence, PLASMA_request *request )
{
    ...
    V = (double**) malloc ( sizeMT * sizeof( double* ) );
    for (k = 0; k < sizeMT; k++) {
        tempk0 = k * A.mb;

        /* Allocate temporary vector and initialize it randomly */
        V[k] = (double*)plasma_shared_alloc(plasma, A.mb, PlasmaRealDouble);
