 ...
 * @ingroup double
 *
 *  PLASMA_dorglq - Generates an M-by-N matrix Q with orthonormal rows, which is
 ...
 * @ingroup double_Tile
 *
 * PLASMA_dorglq_Tile - Generates an M-by-N matrix Q with orthonormal rows,
 * which is defined as the first M rows of a product of the elementary
 * reflectors returned by PLASMA_dgelqf.
