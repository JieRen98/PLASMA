...
void plasma_pzgetrf_rectil_panel_quark(plasma_context_t *plasma,
                                       ...
                                       CORE_zgetrf_data_t *data, PLASMA_desc A, int *IPIV,
...
void plasma_pzgetrf_tntpiv_qrrr_panel_quark(plasma_context_t *plasma,
                                            PLASMA_desc A, int *IPIV,
                                            PLASMA_desc W, int *Wi,
                                            Quark_Task_Flags *task_flags,
                                            PLASMA_sequence *sequence, PLASMA_request *request)
                                 ...
                                 PLASMA_sequence *sequence, PLASMA_request *request)
{
    ...
    if (PLASMA_TNT_MODE == PLASMA_TOURNAMENT_LU)
        panel = plasma_pzgetrf_tntpiv_panel_quark;
    else
        panel = plasma_pzgetrf_tntpiv_qrrr_panel_quark;
