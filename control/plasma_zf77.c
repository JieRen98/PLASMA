...
#define PLASMA_ZGEADD          PLASMA_FNAME(zgeadd       , ZGEADD       )
...
#define PLASMA_ZLASCAL         PLASMA_FNAME(zlascal      , ZLASCAL      )
...
#define PLASMA_ZTRADD          PLASMA_FNAME(ztradd       , ZTRADD       )
 ...
 **/
#define PLASMA_ZGEADD_TILE          PLASMA_TILE_FNAME(zgeadd       , ZGEADD       )
...
#define PLASMA_ZLASCAL_TILE         PLASMA_TILE_FNAME(zlascal      , ZLASCAL      )
...
#define PLASMA_ZTRADD_TILE          PLASMA_TILE_FNAME(ztradd       , ZTRADD       )
 ...
 **/
#define PLASMA_ZGEADD_TILE_ASYNC          PLASMA_ASYNC_FNAME(zgeadd       , ZGEADD       )
...
#define PLASMA_ZLASCAL_TILE_ASYNC         PLASMA_ASYNC_FNAME(zlascal      , ZLASCAL      )
...
#define PLASMA_ZTRADD_TILE_ASYNC          PLASMA_ASYNC_FNAME(ztradd       , ZTRADD       )
...
void PLASMA_ZGEADD(PLASMA_enum *trans, int *M, int *N, PLASMA_Complex64_t *alpha, PLASMA_Complex64_t *A, int *LDA, PLASMA_Complex64_t *beta, PLASMA_Complex64_t *B, int *LDB, int *info)
{ *info = PLASMA_zgeadd(*trans, *M, *N, *alpha, A, *LDA, *beta, B, *LDB); }
...
void PLASMA_ZLASCAL(PLASMA_enum *uplo, int *M, int *N, PLASMA_Complex64_t *alpha, PLASMA_Complex64_t *A, int *LDA, int *info)
{ *info = PLASMA_zlascal(*uplo, *M, *N, *alpha, A, *LDA); }
...
void PLASMA_ZTRADD(PLASMA_enum *uplo, PLASMA_enum *trans, int *M, int *N, PLASMA_Complex64_t *alpha, PLASMA_Complex64_t *A, int *LDA, PLASMA_Complex64_t *beta, PLASMA_Complex64_t *B, int *LDB, int *info)
{ *info = PLASMA_ztradd(*uplo, *trans, *M, *N, *alpha, A, *LDA, *beta, B, *LDB); }
 ...
 *  FORTRAN API - math functions (native interface)
 **/
void PLASMA_ZGEADD_TILE(PLASMA_enum *trans, PLASMA_Complex64_t *alpha, PLASMA_desc **A, PLASMA_Complex64_t *beta, PLASMA_desc **B, int *info)
{ *info = PLASMA_zgeadd_Tile(*trans, *alpha, *A, *beta, *B); }
...
void PLASMA_ZLASCAL_TILE(PLASMA_enum *uplo, PLASMA_Complex64_t *alpha, PLASMA_desc **A, int *info)
{ *info = PLASMA_zlascal_Tile(*uplo, *alpha, *A); }
...
void PLASMA_ZTRADD_TILE(PLASMA_enum *uplo, PLASMA_enum *trans, PLASMA_Complex64_t *alpha, PLASMA_desc **A, PLASMA_Complex64_t *beta, PLASMA_desc **B, int *info)
{ *info = PLASMA_ztradd_Tile(*uplo, *trans, *alpha, *A, *beta, *B); }
 ...
 *  FORTRAN API - math functions (asynchronous interface)
 **/
void PLASMA_ZGEADD_TILE_ASYNC(PLASMA_enum *trans, PLASMA_Complex64_t *alpha, PLASMA_desc **A, PLASMA_Complex64_t *beta, PLASMA_desc **B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zgeadd_Tile_Async(*trans, *alpha, *A, *beta, *B, sequence, request); }
...
void PLASMA_ZLASCAL_TILE_ASYNC(PLASMA_enum *uplo, PLASMA_Complex64_t *alpha, PLASMA_desc **A, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zlascal_Tile_Async(*uplo, *alpha, *A, sequence, request); }
...
void PLASMA_ZTRADD_TILE_ASYNC(PLASMA_enum *uplo, PLASMA_enum *trans, PLASMA_Complex64_t *alpha, PLASMA_desc **A, PLASMA_Complex64_t *beta, PLASMA_desc **B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_ztradd_Tile_Async(*uplo, *trans, *alpha, *A, *beta, *B, sequence, request); }
