...
#define PLASMA_DGEADD          PLASMA_FNAME(dgeadd       , DGEADD       )
...
#define PLASMA_DLASCAL         PLASMA_FNAME(dlascal      , DLASCAL      )
...
#define PLASMA_DSTEDC          PLASMA_FNAME(dstedc       , ZSTEDC       )
#define PLASMA_DSTEDC_ASYNC    PLASMA_FNAME(dstedc_async , ZSTEDC_ASYNC )
#define PLASMA_DSYMM           PLASMA_FNAME(dsymm        , DSYMM        )
#define PLASMA_DSYR2K          PLASMA_FNAME(dsyr2k       , DSYR2K       )
#define PLASMA_DSYRK           PLASMA_FNAME(dsyrk        , DSYRK        )
#define PLASMA_DTRADD          PLASMA_FNAME(dtradd       , DTRADD       )
 ...
 **/
#define PLASMA_DGEADD_TILE          PLASMA_TILE_FNAME(dgeadd       , DGEADD       )
...
#define PLASMA_DLASCAL_TILE         PLASMA_TILE_FNAME(dlascal      , DLASCAL      )
...
#define PLASMA_DSYR2K_TILE          PLASMA_TILE_FNAME(dsyr2k       , DSYR2K       )
#define PLASMA_DSYRK_TILE           PLASMA_TILE_FNAME(dsyrk        , DSYRK        )
#define PLASMA_DTRADD_TILE          PLASMA_TILE_FNAME(dtradd       , DTRADD       )
 ...
 **/
#define PLASMA_DGEADD_TILE_ASYNC          PLASMA_ASYNC_FNAME(dgeadd       , DGEADD       )
...
#define PLASMA_DLASCAL_TILE_ASYNC         PLASMA_ASYNC_FNAME(dlascal      , DLASCAL      )
...
#define PLASMA_DSYR2K_TILE_ASYNC          PLASMA_ASYNC_FNAME(dsyr2k       , DSYR2K       )
#define PLASMA_DSYRK_TILE_ASYNC           PLASMA_ASYNC_FNAME(dsyrk        , DSYRK        )
#define PLASMA_DTRADD_TILE_ASYNC          PLASMA_ASYNC_FNAME(dtradd       , DTRADD       )
...
void PLASMA_DGEADD(PLASMA_enum *trans, int *M, int *N, double *alpha, double *A, int *LDA, double *beta, double *B, int *LDB, int *info)
{ *info = PLASMA_dgeadd(*trans, *M, *N, *alpha, A, *LDA, *beta, B, *LDB); }
...
void PLASMA_DLASCAL(PLASMA_enum *uplo, int *M, int *N, double *alpha, double *A, int *LDA, int *info)
{ *info = PLASMA_dlascal(*uplo, *M, *N, *alpha, A, *LDA); }
...
void PLASMA_DSTEDC(PLASMA_enum *jobz, int *n, double *D, double *E, double *Z, int *LDZ, int *info)
{ *info = PLASMA_dstedc(*jobz, *n, D, E, Z, *LDZ); }

void PLASMA_DSTEDC_ASYNC(PLASMA_enum *jobz, int *n, double *D, double *E, double *Z, int *LDZ, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_dstedc_Async(*jobz, *n, D, E, Z, *LDZ, sequence, request); }
...
void PLASMA_DTRADD(PLASMA_enum *uplo, PLASMA_enum *trans, int *M, int *N, double *alpha, double *A, int *LDA, double *beta, double *B, int *LDB, int *info)
{ *info = PLASMA_dtradd(*uplo, *trans, *M, *N, *alpha, A, *LDA, *beta, B, *LDB); }
 ...
 *  FORTRAN API - math functions (native interface)
 **/
void PLASMA_DGEADD_TILE(PLASMA_enum *trans, double *alpha, PLASMA_desc **A, double *beta, PLASMA_desc **B, int *info)
{ *info = PLASMA_dgeadd_Tile(*trans, *alpha, *A, *beta, *B); }
...
void PLASMA_DLASCAL_TILE(PLASMA_enum *uplo, double *alpha, PLASMA_desc **A, int *info)
{ *info = PLASMA_dlascal_Tile(*uplo, *alpha, *A); }
...
void PLASMA_DTRADD_TILE(PLASMA_enum *uplo, PLASMA_enum *trans, double *alpha, PLASMA_desc **A, double *beta, PLASMA_desc **B, int *info)
{ *info = PLASMA_dtradd_Tile(*uplo, *trans, *alpha, *A, *beta, *B); }
 ...
 *  FORTRAN API - math functions (asynchronous interface)
 **/
void PLASMA_DGEADD_TILE_ASYNC(PLASMA_enum *trans, double *alpha, PLASMA_desc **A, double *beta, PLASMA_desc **B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_dgeadd_Tile_Async(*trans, *alpha, *A, *beta, *B, sequence, request); }
...
void PLASMA_DLASCAL_TILE_ASYNC(PLASMA_enum *uplo, double *alpha, PLASMA_desc **A, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_dlascal_Tile_Async(*uplo, *alpha, *A, sequence, request); }
...
void PLASMA_DTRADD_TILE_ASYNC(PLASMA_enum *uplo, PLASMA_enum *trans, double *alpha, PLASMA_desc **A, double *beta, PLASMA_desc **B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_dtradd_Tile_Async(*uplo, *trans, *alpha, *A, *beta, *B, sequence, request); }
