...
#define PLASMA_SGEADD          PLASMA_FNAME(sgeadd       , SGEADD       )
...
#define PLASMA_SLASCAL         PLASMA_FNAME(slascal      , SLASCAL      )
...
#define PLASMA_SSTEDC          PLASMA_FNAME(sstedc       , ZSTEDC       )
#define PLASMA_SSTEDC_ASYNC    PLASMA_FNAME(sstedc_async , ZSTEDC_ASYNC )
#define PLASMA_SSYMM           PLASMA_FNAME(ssymm        , SSYMM        )
#define PLASMA_SSYR2K          PLASMA_FNAME(ssyr2k       , SSYR2K       )
#define PLASMA_SSYRK           PLASMA_FNAME(ssyrk        , SSYRK        )
#define PLASMA_STRADD          PLASMA_FNAME(stradd       , STRADD       )
 ...
 **/
#define PLASMA_SGEADD_TILE          PLASMA_TILE_FNAME(sgeadd       , SGEADD       )
...
#define PLASMA_SLASCAL_TILE         PLASMA_TILE_FNAME(slascal      , SLASCAL      )
...
#define PLASMA_SSYR2K_TILE          PLASMA_TILE_FNAME(ssyr2k       , SSYR2K       )
#define PLASMA_SSYRK_TILE           PLASMA_TILE_FNAME(ssyrk        , SSYRK        )
#define PLASMA_STRADD_TILE          PLASMA_TILE_FNAME(stradd       , STRADD       )
 ...
 **/
#define PLASMA_SGEADD_TILE_ASYNC          PLASMA_ASYNC_FNAME(sgeadd       , SGEADD       )
...
#define PLASMA_SLASCAL_TILE_ASYNC         PLASMA_ASYNC_FNAME(slascal      , SLASCAL      )
...
#define PLASMA_SSYR2K_TILE_ASYNC          PLASMA_ASYNC_FNAME(ssyr2k       , SSYR2K       )
#define PLASMA_SSYRK_TILE_ASYNC           PLASMA_ASYNC_FNAME(ssyrk        , SSYRK        )
#define PLASMA_STRADD_TILE_ASYNC          PLASMA_ASYNC_FNAME(stradd       , STRADD       )
...
void PLASMA_SGEADD(PLASMA_enum *trans, int *M, int *N, float *alpha, float *A, int *LDA, float *beta, float *B, int *LDB, int *info)
{ *info = PLASMA_sgeadd(*trans, *M, *N, *alpha, A, *LDA, *beta, B, *LDB); }
...
void PLASMA_SLASCAL(PLASMA_enum *uplo, int *M, int *N, float *alpha, float *A, int *LDA, int *info)
{ *info = PLASMA_slascal(*uplo, *M, *N, *alpha, A, *LDA); }
...
void PLASMA_SSTEDC(PLASMA_enum *jobz, int *n, float *D, float *E, float *Z, int *LDZ, int *info)
{ *info = PLASMA_sstedc(*jobz, *n, D, E, Z, *LDZ); }

void PLASMA_SSTEDC_ASYNC(PLASMA_enum *jobz, int *n, float *D, float *E, float *Z, int *LDZ, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_sstedc_Async(*jobz, *n, D, E, Z, *LDZ, sequence, request); }
...
void PLASMA_STRADD(PLASMA_enum *uplo, PLASMA_enum *trans, int *M, int *N, float *alpha, float *A, int *LDA, float *beta, float *B, int *LDB, int *info)
{ *info = PLASMA_stradd(*uplo, *trans, *M, *N, *alpha, A, *LDA, *beta, B, *LDB); }
 ...
 *  FORTRAN API - math functions (native interface)
 **/
void PLASMA_SGEADD_TILE(PLASMA_enum *trans, float *alpha, PLASMA_desc **A, float *beta, PLASMA_desc **B, int *info)
{ *info = PLASMA_sgeadd_Tile(*trans, *alpha, *A, *beta, *B); }
...
void PLASMA_SLASCAL_TILE(PLASMA_enum *uplo, float *alpha, PLASMA_desc **A, int *info)
{ *info = PLASMA_slascal_Tile(*uplo, *alpha, *A); }
...
void PLASMA_STRADD_TILE(PLASMA_enum *uplo, PLASMA_enum *trans, float *alpha, PLASMA_desc **A, float *beta, PLASMA_desc **B, int *info)
{ *info = PLASMA_stradd_Tile(*uplo, *trans, *alpha, *A, *beta, *B); }
 ...
 *  FORTRAN API - math functions (asynchronous interface)
 **/
void PLASMA_SGEADD_TILE_ASYNC(PLASMA_enum *trans, float *alpha, PLASMA_desc **A, float *beta, PLASMA_desc **B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_sgeadd_Tile_Async(*trans, *alpha, *A, *beta, *B, sequence, request); }
...
void PLASMA_SLASCAL_TILE_ASYNC(PLASMA_enum *uplo, float *alpha, PLASMA_desc **A, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_slascal_Tile_Async(*uplo, *alpha, *A, sequence, request); }
...
void PLASMA_STRADD_TILE_ASYNC(PLASMA_enum *uplo, PLASMA_enum *trans, float *alpha, PLASMA_desc **A, float *beta, PLASMA_desc **B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_stradd_Tile_Async(*uplo, *trans, *alpha, *A, *beta, *B, sequence, request); }
