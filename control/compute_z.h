 ...
 **/
void plasma_pztradd  (plasma_context_t *plasma);
 ...
 **/
#ifdef REAL
void plasma_pdlaed0_quark(int icompq, char range, int id1, int n, double *D, double *E, int il, int iu, double vl, double vu, double *Q, int LDQ, double *qstore, int lwork, double *WORK, double *WORK2, int LDWORK, int *IWORK, int *localdata, PLASMA_sequence *sequence, PLASMA_request *request);
void plasma_pdlaed1_quark(char range, int n, int n1, double *D, int il, int iu, double vl, double vu, double *Q, int LDQ, int *INDXQ, double *beta, double *work, double *work2, int *iwork, int *K1, int *K2, int last_merge, PLASMA_sequence *sequence, PLASMA_request *request);
#endif
#ifdef COMPLEX
void plasma_pdlag2z_quark(int m, int n, const double *R, int ldr, PLASMA_Complex64_t *Z, int LDZ, PLASMA_sequence *sequence, PLASMA_request *request);
#endif
void plasma_pztradd_quark(PLASMA_enum uplo, PLASMA_enum trans, PLASMA_Complex64_t alpha, PLASMA_desc A, PLASMA_Complex64_t beta, PLASMA_desc B, PLASMA_sequence *sequence, PLASMA_request *request);
...
void plasma_pzlascal_quark( PLASMA_enum uplo, PLASMA_Complex64_t alpha, PLASMA_desc A, PLASMA_sequence *sequence, PLASMA_request *request);
...
void plasma_pzlaset_identity_quark(int n, PLASMA_Complex64_t *A, int lda, PLASMA_sequence *sequence, PLASMA_request *request);
...
void plasma_pzstedc_quark(PLASMA_enum compz, int matsiz, double *D, double *E, PLASMA_Complex64_t *Z, int LDZ, PLASMA_sequence *sequence, PLASMA_request *request);
void plasma_pzswaps_quark(int n, int *perm, PLASMA_Complex64_t *Z, int LDZ, PLASMA_Complex64_t *work, PLASMA_sequence *sequence, PLASMA_request *request);
...
//double PLASMA_FCALL(zlanst,ZLANST)(char *type, int *n, double *D, double *E);
//void   PLASMA_FCALL(zlascl,ZLASCL)(char *type, int *i1, int *i2,
//                                   double *scale, double *scale2,
//                                   int *n, int *i4, PLASMA_Complex64_t *D, int *m, int *info);
//void   PLASMA_FCALL(zlamrg,ZLAMRG)(int *K, int *n2, double *D, int *id1, int *id2, int *INDXQ);
//
//#ifdef REAL
//PLASMA_Complex64_t PLASMA_FCALL(zlapy2,ZLAPY2)(PLASMA_Complex64_t *f1, PLASMA_Complex64_t *f2);
//PLASMA_Complex64_t PLASMA_FCALL(zlamc3,ZLAMC3)(PLASMA_Complex64_t *f1, PLASMA_Complex64_t *f2);
//void               PLASMA_FCALL(zlaed4,ZLAED4)(const int *n, const int *i, const double *D,
//                                               const double *Z, double *delta, const double *beta,
//                                               double *Di, int *info);
//#endif
