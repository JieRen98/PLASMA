...
#define PLASMA_CGEADD          PLASMA_FNAME(cgeadd       , CGEADD       )
...
#define PLASMA_CLASCAL         PLASMA_FNAME(clascal      , CLASCAL      )
...
#define PLASMA_CSTEDC          PLASMA_FNAME(cstedc       , ZSTEDC       )
#define PLASMA_CSTEDC_ASYNC    PLASMA_FNAME(cstedc_async , ZSTEDC_ASYNC )
...
#define PLASMA_CTRADD          PLASMA_FNAME(ctradd       , CTRADD       )
 ...
 **/
#define PLASMA_CGEADD_TILE          PLASMA_TILE_FNAME(cgeadd       , CGEADD       )
...
#define PLASMA_CLASCAL_TILE         PLASMA_TILE_FNAME(clascal      , CLASCAL      )
...
#define PLASMA_CTRADD_TILE          PLASMA_TILE_FNAME(ctradd       , CTRADD       )
 ...
 **/
#define PLASMA_CGEADD_TILE_ASYNC          PLASMA_ASYNC_FNAME(cgeadd       , CGEADD       )
...
#define PLASMA_CLASCAL_TILE_ASYNC         PLASMA_ASYNC_FNAME(clascal      , CLASCAL      )
...
#define PLASMA_CTRADD_TILE_ASYNC          PLASMA_ASYNC_FNAME(ctradd       , CTRADD       )
...
void PLASMA_CGEADD(PLASMA_enum *trans, int *M, int *N, PLASMA_Complex32_t *alpha, PLASMA_Complex32_t *A, int *LDA, PLASMA_Complex32_t *beta, PLASMA_Complex32_t *B, int *LDB, int *info)
{ *info = PLASMA_cgeadd(*trans, *M, *N, *alpha, A, *LDA, *beta, B, *LDB); }
...
void PLASMA_CLASCAL(PLASMA_enum *uplo, int *M, int *N, PLASMA_Complex32_t *alpha, PLASMA_Complex32_t *A, int *LDA, int *info)
{ *info = PLASMA_clascal(*uplo, *M, *N, *alpha, A, *LDA); }
...
void PLASMA_CSTEDC(PLASMA_enum *jobz, int *n, float *D, float *E, PLASMA_Complex32_t *Z, int *LDZ, int *info)
{ *info = PLASMA_cstedc(*jobz, *n, D, E, Z, *LDZ); }

void PLASMA_CSTEDC_ASYNC(PLASMA_enum *jobz, int *n, float *D, float *E, PLASMA_Complex32_t *Z, int *LDZ, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_cstedc_Async(*jobz, *n, D, E, Z, *LDZ, sequence, request); }
...
void PLASMA_CTRADD(PLASMA_enum *uplo, PLASMA_enum *trans, int *M, int *N, PLASMA_Complex32_t *alpha, PLASMA_Complex32_t *A, int *LDA, PLASMA_Complex32_t *beta, PLASMA_Complex32_t *B, int *LDB, int *info)
{ *info = PLASMA_ctradd(*uplo, *trans, *M, *N, *alpha, A, *LDA, *beta, B, *LDB); }
 ...
 *  FORTRAN API - math functions (native interface)
 **/
void PLASMA_CGEADD_TILE(PLASMA_enum *trans, PLASMA_Complex32_t *alpha, PLASMA_desc **A, PLASMA_Complex32_t *beta, PLASMA_desc **B, int *info)
{ *info = PLASMA_cgeadd_Tile(*trans, *alpha, *A, *beta, *B); }
...
void PLASMA_CLASCAL_TILE(PLASMA_enum *uplo, PLASMA_Complex32_t *alpha, PLASMA_desc **A, int *info)
{ *info = PLASMA_clascal_Tile(*uplo, *alpha, *A); }
...
void PLASMA_CTRADD_TILE(PLASMA_enum *uplo, PLASMA_enum *trans, PLASMA_Complex32_t *alpha, PLASMA_desc **A, PLASMA_Complex32_t *beta, PLASMA_desc **B, int *info)
{ *info = PLASMA_ctradd_Tile(*uplo, *trans, *alpha, *A, *beta, *B); }
 ...
 *  FORTRAN API - math functions (asynchronous interface)
 **/
void PLASMA_CGEADD_TILE_ASYNC(PLASMA_enum *trans, PLASMA_Complex32_t *alpha, PLASMA_desc **A, PLASMA_Complex32_t *beta, PLASMA_desc **B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_cgeadd_Tile_Async(*trans, *alpha, *A, *beta, *B, sequence, request); }
...
void PLASMA_CLASCAL_TILE_ASYNC(PLASMA_enum *uplo, PLASMA_Complex32_t *alpha, PLASMA_desc **A, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_clascal_Tile_Async(*uplo, *alpha, *A, sequence, request); }
...
void PLASMA_CTRADD_TILE_ASYNC(PLASMA_enum *uplo, PLASMA_enum *trans, PLASMA_Complex32_t *alpha, PLASMA_desc **A, PLASMA_Complex32_t *beta, PLASMA_desc **B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_ctradd_Tile_Async(*uplo, *trans, *alpha, *A, *beta, *B, sequence, request); }
